...
cljs.core.with_meta = function with_meta(b, c) {
  ...
  return d ? with_meta.call(null, function() {
    if(void 0 === cljs.core.t4862) {
      cljs.core.t4862 = {};
      cljs.core.t4862 = function(b, c, d, e) {
        this.meta = b;
        this.o = c;
        this.with_meta = d;
        this.meta4863 = e;
      ...
      cljs.core.t4862.cljs$lang$type = !0;
      cljs.core.t4862.cljs$lang$ctorStr = "cljs.core/t4862";
      cljs.core.t4862.cljs$lang$ctorPrWriter = function(b, c) {
        return cljs.core._write.call(null, c, "cljs.core/t4862")
      };
      var d = cljs.core.t4862.prototype, f = function(b, c) {
      ...
      d.call = g;
      cljs.core.t4862.prototype.apply = function(b, c) {
        b = this;
        return b.call.apply(b, [b].concat(c.slice()))
      };
      cljs.core.t4862.prototype.cljs$core$Fn$ = !0;
      cljs.core.t4862.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
        return this.meta4863
      };
      cljs.core.t4862.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
        return new cljs.core.t4862(this.meta, this.o, this.with_meta, c)
      }
    }
    return new cljs.core.t4862(c, b, with_meta, null)
...
var ten_seconds = {utils:{}};
ten_seconds.utils.point_in_circle_QMARK_ = function(a, b, c) {
  var d = (new cljs.core.Keyword("\ufdd0:x")).call(null, c), e = (new cljs.core.Keyword("\ufdd0:y")).call(null, c), a = Math.abs.call(null, a - d), b = Math.abs.call(null, b - e), c = (new cljs.core.Keyword("\ufdd0:radius")).call(null, c);
  return a > c ? !1 : b > c ? !1 : a + b <= c ? !0 : a * a + b * b <= c * c ? !0 : !1
};
ten_seconds.utils.point_in_rect_QMARK_ = function(a, b, c) {
  var d = (new cljs.core.Keyword("\ufdd0:left")).call(null, c), e = d + (new cljs.core.Keyword("\ufdd0:width")).call(null, c), f = (new cljs.core.Keyword("\ufdd0:top")).call(null, c), g = f + (new cljs.core.Keyword("\ufdd0:height")).call(null, c);
  return function() {
    var c = a >= d;
    return c && (c = a <= e) ? (c = b >= f) ? b <= g : c : c
  }()
};
ten_seconds.utils.is_obj_hit_QMARK_ = function(a, b, c) {
  return cljs.core._EQ_.call(null, "circle", (new cljs.core.Keyword("\ufdd0:type")).call(null, c)) ? ten_seconds.utils.point_in_circle_QMARK_.call(null, a, b, c) : cljs.core._EQ_.call(null, "rect", (new cljs.core.Keyword("\ufdd0:type")).call(null, c)) ? ten_seconds.utils.point_in_rect_QMARK_.call(null, a, b, c) : null
};
ten_seconds.utils.hit_test = function(a, b, c) {
  return cljs.core.filter.call(null, function(c) {
    return ten_seconds.utils.is_obj_hit_QMARK_.call(null, a, b, c)
  }, c)
};
ten_seconds.utils.find_value = function(a, b) {
  for(;;) {
    if(cljs.core.seq.call(null, b)) {
      if(cljs.core._EQ_.call(null, a, cljs.core.first.call(null, b))) {
        return!0
      }
      var c = a, d = cljs.core.rest.call(null, b), a = c, b = d
    }else {
      return!1
    }
  }
};
ten_seconds.utils.difference = function(a, b) {
  return cljs.core.remove.call(null, function(a) {
    return ten_seconds.utils.find_value.call(null, a, b)
  }, a)
};
ten_seconds.utils.hsv_to_rgb = function(a, b, c) {
  return cljs.core.map.call(null, function(a) {
    return 255 * a | 0
  }, function() {
    var d = a / 60 | 0, e = a / 60 - d, f = c * (1 - b), g = c * (1 - b * e), e = c * (1 - b * (1 - e)), h = cljs.core._EQ_;
    if(h.call(null, 0, d)) {
      return cljs.core.list.call(null, c, e, g)
    }
    if(h.call(null, 1, d)) {
      return cljs.core.list.call(null, g, c, f)
    }
    if(h.call(null, 2, d)) {
      return cljs.core.list.call(null, f, c, e)
    }
    if(h.call(null, 3, d)) {
      return cljs.core.list.call(null, f, g, c)
    }
    if(h.call(null, 4, d)) {
      return cljs.core.list.call(null, e, f, c)
    }
    if(h.call(null, 5, d)) {
      return cljs.core.list.call(null, c, f, g)
    }
...
cljs.core.async.impl.ioc_helpers.fn_handler = function fn_handler(b) {
  void 0 === cljs.core.async.impl.ioc_helpers.t5698 && (cljs.core.async.impl.ioc_helpers.t5698 = {}, cljs.core.async.impl.ioc_helpers.t5698 = function(b, d, e) {
    this.f = b;
    this.fn_handler = d;
    this.meta5699 = e;
    this.cljs$lang$protocol_mask$partition1$ = 0;
    this.cljs$lang$protocol_mask$partition0$ = 393216
  }, cljs.core.async.impl.ioc_helpers.t5698.cljs$lang$type = !0, cljs.core.async.impl.ioc_helpers.t5698.cljs$lang$ctorStr = "cljs.core.async.impl.ioc-helpers/t5698", cljs.core.async.impl.ioc_helpers.t5698.cljs$lang$ctorPrWriter = function(b, d) {
    return cljs.core._write.call(null, d, "cljs.core.async.impl.ioc-helpers/t5698")
  }, cljs.core.async.impl.ioc_helpers.t5698.prototype.cljs$core$async$impl$protocols$Handler$ = !0, cljs.core.async.impl.ioc_helpers.t5698.prototype.cljs$core$async$impl$protocols$Handler$active_QMARK_$arity$1 = function() {
    return!0
  }, cljs.core.async.impl.ioc_helpers.t5698.prototype.cljs$core$async$impl$protocols$Handler$commit$arity$1 = function() {
    return this.f
  }, cljs.core.async.impl.ioc_helpers.t5698.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
    return this.meta5699
  }, cljs.core.async.impl.ioc_helpers.t5698.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, d) {
    return new cljs.core.async.impl.ioc_helpers.t5698(this.f, this.fn_handler, d)
  });
  return new cljs.core.async.impl.ioc_helpers.t5698(b, fn_handler, null)
};
...
cljs.core.async.impl.channels.box = function box(b) {
  void 0 === cljs.core.async.impl.channels.t5689 && (cljs.core.async.impl.channels.t5689 = {}, cljs.core.async.impl.channels.t5689 = function(b, d, e) {
    this.val = b;
    this.box = d;
    this.meta5690 = e;
    this.cljs$lang$protocol_mask$partition1$ = 0;
    this.cljs$lang$protocol_mask$partition0$ = 425984
  }, cljs.core.async.impl.channels.t5689.cljs$lang$type = !0, cljs.core.async.impl.channels.t5689.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t5689", cljs.core.async.impl.channels.t5689.cljs$lang$ctorPrWriter = function(b, d) {
    return cljs.core._write.call(null, d, "cljs.core.async.impl.channels/t5689")
  }, cljs.core.async.impl.channels.t5689.prototype.cljs$core$IDeref$_deref$arity$1 = function() {
    return this.val
  }, cljs.core.async.impl.channels.t5689.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
    return this.meta5690
  }, cljs.core.async.impl.channels.t5689.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, d) {
    return new cljs.core.async.impl.channels.t5689(this.val, this.box, d)
  });
  return new cljs.core.async.impl.channels.t5689(b, box, null)
};
    ...
    for(;;) {
      ...
      if(null != d) {
        ...
        if(!(this.takes.length < cljs.core.async.impl.protocols.MAX_QUEUE_SIZE)) {
          ...
          new cljs.core.Symbol(null, "takes", "takes", -1530407291, null)), cljs.core.hash_map("\ufdd0:line", 76, "\ufdd0:column", 30)), new cljs.core.Symbol("impl", "MAX-QUEUE-SIZE", "impl/MAX-QUEUE-SIZE", -1989946393, null)), cljs.core.hash_map("\ufdd0:line", 76, "\ufdd0:column", 27))))].join(""));
        }
...
cljs.core.async.impl.channels.chan = function(a) {
  return new cljs.core.async.impl.channels.ManyToManyChannel(cljs.core.async.impl.buffers.ring_buffer.call(null, 32), cljs.core.async.impl.buffers.ring_buffer.call(null, 32), a, null)
};
...
cljs.core.async.fn_handler = function fn_handler$$0(b) {
  void 0 === cljs.core.async.t5633 && (cljs.core.async.t5633 = {}, cljs.core.async.t5633 = function(b, d, e) {
    this.f = b;
    this.fn_handler = d;
    this.meta5634 = e;
    this.cljs$lang$protocol_mask$partition1$ = 0;
    this.cljs$lang$protocol_mask$partition0$ = 393216
  }, cljs.core.async.t5633.cljs$lang$type = !0, cljs.core.async.t5633.cljs$lang$ctorStr = "cljs.core.async/t5633", cljs.core.async.t5633.cljs$lang$ctorPrWriter = function(b, d) {
    return cljs.core._write.call(null, d, "cljs.core.async/t5633")
  }, cljs.core.async.t5633.prototype.cljs$core$async$impl$protocols$Handler$ = !0, cljs.core.async.t5633.prototype.cljs$core$async$impl$protocols$Handler$active_QMARK_$arity$1 = function() {
    return!0
  }, cljs.core.async.t5633.prototype.cljs$core$async$impl$protocols$Handler$commit$arity$1 = function() {
    return this.f
  }, cljs.core.async.t5633.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
    return this.meta5634
  }, cljs.core.async.t5633.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, d) {
    return new cljs.core.async.t5633(this.f, this.fn_handler, d)
  });
  return new cljs.core.async.t5633(b, fn_handler$$0, null)
};
...
cljs.core.async.alt_flag = function alt_flag() {
  ...
  void 0 === cljs.core.async.t5644 && (cljs.core.async.t5644 = {}, cljs.core.async.t5644 = function(b, d, e) {
    this.flag = b;
    this.alt_flag = d;
    this.meta5645 = e;
    this.cljs$lang$protocol_mask$partition1$ = 0;
    this.cljs$lang$protocol_mask$partition0$ = 393216
  }, cljs.core.async.t5644.cljs$lang$type = !0, cljs.core.async.t5644.cljs$lang$ctorStr = "cljs.core.async/t5644", cljs.core.async.t5644.cljs$lang$ctorPrWriter = function(b, d) {
    return cljs.core._write.call(null, d, "cljs.core.async/t5644")
  }, cljs.core.async.t5644.prototype.cljs$core$async$impl$protocols$Handler$ = !0, cljs.core.async.t5644.prototype.cljs$core$async$impl$protocols$Handler$active_QMARK_$arity$1 = function() {
    return cljs.core.deref.call(null, this.flag)
  }, cljs.core.async.t5644.prototype.cljs$core$async$impl$protocols$Handler$commit$arity$1 = function() {
    cljs.core.reset_BANG_.call(null, this.flag, null);
    return!0
  }, cljs.core.async.t5644.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
    return this.meta5645
  }, cljs.core.async.t5644.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, d) {
    return new cljs.core.async.t5644(this.flag, this.alt_flag, d)
  });
  return new cljs.core.async.t5644(b, alt_flag, null)
};
cljs.core.async.alt_handler = function alt_handler(b, c) {
  void 0 === cljs.core.async.t5651 && (cljs.core.async.t5651 = {}, cljs.core.async.t5651 = function(b, c, f, g) {
    this.cb = b;
    this.flag = c;
    this.alt_handler = f;
    this.meta5652 = g;
    this.cljs$lang$protocol_mask$partition1$ = 0;
    this.cljs$lang$protocol_mask$partition0$ = 393216
  }, cljs.core.async.t5651.cljs$lang$type = !0, cljs.core.async.t5651.cljs$lang$ctorStr = "cljs.core.async/t5651", cljs.core.async.t5651.cljs$lang$ctorPrWriter = function(b, c) {
    return cljs.core._write.call(null, c, "cljs.core.async/t5651")
  }, cljs.core.async.t5651.prototype.cljs$core$async$impl$protocols$Handler$ = !0, cljs.core.async.t5651.prototype.cljs$core$async$impl$protocols$Handler$active_QMARK_$arity$1 = function() {
    return cljs.core.async.impl.protocols.active_QMARK_.call(null, this.flag)
  }, cljs.core.async.t5651.prototype.cljs$core$async$impl$protocols$Handler$commit$arity$1 = function() {
    cljs.core.async.impl.protocols.commit.call(null, this.flag);
    return this.cb
  }, cljs.core.async.t5651.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
    return this.meta5652
  }, cljs.core.async.t5651.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
    return new cljs.core.async.t5651(this.cb, this.flag, this.alt_handler, c)
  });
  return new cljs.core.async.t5651(c, b, alt_handler, null)
};
...
ten_seconds.levels.generate_random_rect = function() {
  var a = ten_seconds.levels.min_y_pos + cljs.core.rand_int.call(null, ten_seconds.levels.diff_y_pos), b = ten_seconds.levels.min_x_pos + cljs.core.rand_int.call(null, ten_seconds.levels.diff_x_pos), c = ten_seconds.levels.min_width + cljs.core.rand_int.call(null, ten_seconds.levels.diff_width), d = ten_seconds.levels.min_height + cljs.core.rand_int.call(null, ten_seconds.levels.diff_height), e = ten_seconds.utils.hsv_to_rgb.call(null, 360 * cljs.core.rand.call(null), 0.5, 0.95);
  return cljs.core.PersistentArrayMap.fromArray(["\ufdd0:type", "rect", "\ufdd0:top", a, "\ufdd0:left", b, "\ufdd0:width", c, "\ufdd0:height", d, "\ufdd0:color", e, "\ufdd0:alpha", 0.8], !0)
};
ten_seconds.levels.generate_random_circle = function() {
  var a = ten_seconds.levels.min_y_pos + cljs.core.rand_int.call(null, ten_seconds.levels.diff_y_pos), b = ten_seconds.levels.min_x_pos + cljs.core.rand_int.call(null, ten_seconds.levels.diff_x_pos), c = ten_seconds.levels.min_width + cljs.core.rand_int.call(null, ten_seconds.levels.diff_width), d = ten_seconds.utils.hsv_to_rgb.call(null, 360 * cljs.core.rand.call(null), 0.5, 0.95);
  return cljs.core.PersistentArrayMap.fromArray(["\ufdd0:type", "circle", "\ufdd0:x", b, "\ufdd0:y", a, "\ufdd0:radius", c, "\ufdd0:color", d, "\ufdd0:alpha", 0.8], !0)
};
ten_seconds.levels.generate_random_object = function() {
  var a = cljs.core.rand_int.call(null, 2);
  return cljs.core._EQ_.call(null, 0, a) ? ten_seconds.levels.generate_random_rect.call(null) : cljs.core._EQ_.call(null, 1, a) ? ten_seconds.levels.generate_random_circle.call(null) : null
};
ten_seconds.levels.generate_random_object_list = function(a, b) {
  var c = cljs.core.rand_int.call(null, b - a);
  return cljs.core.map.call(null, function() {
    return ten_seconds.levels.generate_random_object.call(null)
  }, cljs.core.range.call(null, a + c))
};
ten_seconds.levels.replace_object = function() {
  var a = ten_seconds.levels.generate_random_object.call(null);
  return cljs.core.assoc.call(null, a, "\ufdd0:changed", !0)
};
ten_seconds.levels.change_object_position = function() {
  ...
  return new cljs.core.MultiFn("change-object-position", "\ufdd0:type", "\ufdd0:default", e, a, b, c, d)
}();
cljs.core._add_method.call(null, ten_seconds.levels.change_object_position, "circle", function(a) {
  var b = ten_seconds.levels.min_y_pos + cljs.core.rand_int.call(null, ten_seconds.levels.diff_y_pos), c = ten_seconds.levels.min_x_pos + cljs.core.rand_int.call(null, ten_seconds.levels.diff_x_pos);
  return cljs.core.assoc.call(null, a, "\ufdd0:x", c, "\ufdd0:y", b, "\ufdd0:changed", !0)
});
cljs.core._add_method.call(null, ten_seconds.levels.change_object_position, "rect", function(a) {
  var b = ten_seconds.levels.min_y_pos + cljs.core.rand_int.call(null, ten_seconds.levels.diff_y_pos), c = ten_seconds.levels.min_x_pos + cljs.core.rand_int.call(null, ten_seconds.levels.diff_x_pos);
  return cljs.core.assoc.call(null, a, "\ufdd0:x", c, "\ufdd0:y", b, "\ufdd0:changed", !0)
});
cljs.core._add_method.call(null, ten_seconds.levels.change_object_position, "\ufdd0:default", function(a) {
  return console.log("Failed position", a)
});
ten_seconds.levels.change_object_size = function() {
  var a = cljs.core.atom.call(null, cljs.core.ObjMap.EMPTY), b = cljs.core.atom.call(null, cljs.core.ObjMap.EMPTY), c = cljs.core.atom.call(null, cljs.core.ObjMap.EMPTY), d = cljs.core.atom.call(null, cljs.core.ObjMap.EMPTY), e = cljs.core.get.call(null, cljs.core.ObjMap.EMPTY, "\ufdd0:hierarchy", cljs.core.get_global_hierarchy.call(null));
  return new cljs.core.MultiFn("change-object-size", "\ufdd0:type", "\ufdd0:default", e, a, b, c, d)
}();
cljs.core._add_method.call(null, ten_seconds.levels.change_object_size, "circle", function(a) {
  var b = ten_seconds.levels.min_width + cljs.core.rand_int.call(null, ten_seconds.levels.diff_width);
  return cljs.core.assoc.call(null, a, "\ufdd0:radius", b, "\ufdd0:changed", !0)
});
cljs.core._add_method.call(null, ten_seconds.levels.change_object_size, "rect", function(a) {
  var b = ten_seconds.levels.min_width + cljs.core.rand_int.call(null, ten_seconds.levels.diff_width), c = ten_seconds.levels.min_height + cljs.core.rand_int.call(null, ten_seconds.levels.diff_height);
  return cljs.core.assoc.call(null, a, "\ufdd0:width", b, "\ufdd0:height", c, "\ufdd0:changed", !0)
});
cljs.core._add_method.call(null, ten_seconds.levels.change_object_size, "\ufdd0:default", function(a) {
  return console.log("Failed size", a)
});
ten_seconds.levels.change_object_color = function(a) {
  var b = ten_seconds.utils.hsv_to_rgb.call(null, 360 * cljs.core.rand.call(null), 0.5, 0.95);
  return cljs.core.assoc.call(null, a, "\ufdd0:color", b, "\ufdd0:changed", !0)
};
ten_seconds.levels.change_object = function(a) {
  var b = cljs.core.rand_int.call(null, 3);
  return cljs.core._EQ_.call(null, 0, b) ? ten_seconds.levels.change_object_position.call(null, a) : cljs.core._EQ_.call(null, 1, b) ? ten_seconds.levels.change_object_size.call(null, a) : cljs.core._EQ_.call(null, 2, b) ? ten_seconds.levels.change_object_color.call(null, a) : null
};
ten_seconds.levels.leave_replace_change = function(a) {
  var b = cljs.core.rand_int.call(null, 10);
  return cljs.core._EQ_.call(null, 0, b) ? ten_seconds.levels.replace_object.call(null) : cljs.core._EQ_.call(null, 1, b) ? ten_seconds.levels.change_object.call(null, a) : a
};
ten_seconds.levels.mutate_object_list = function(a) {
  return cljs.core.cons.call(null, ten_seconds.levels.replace_object.call(null), cljs.core.map.call(null, ten_seconds.levels.leave_replace_change, cljs.core.rest.call(null, a)))
};
...
ten_seconds.levels.on_animate = function() {
  var a = cljs.core.atom.call(null, cljs.core.ObjMap.EMPTY), b = cljs.core.atom.call(null, cljs.core.ObjMap.EMPTY), c = cljs.core.atom.call(null, cljs.core.ObjMap.EMPTY), d = cljs.core.atom.call(null, cljs.core.ObjMap.EMPTY), e = cljs.core.get.call(null, cljs.core.ObjMap.EMPTY, "\ufdd0:hierarchy", cljs.core.get_global_hierarchy.call(null));
  return new cljs.core.MultiFn("on-animate", "\ufdd0:state", "\ufdd0:default", e, a, b, c, d)
}();
cljs.core._add_method.call(null, ten_seconds.levels.on_animate, "first", function(a) {
  var b = cljs.core.deref.call(null, ten_seconds.levels.difficulty) | 0, c = ten_seconds.levels.generate_random_object_list.call(null, b, b), b = ten_seconds.levels.mutate_object_list.call(null, c), c = cljs.core.cons.call(null, (new cljs.core.Keyword("\ufdd0:display-counter")).call(null, a), c), b = cljs.core.cons.call(null, (new cljs.core.Keyword("\ufdd0:display-counter")).call(null, a), b);
  cljs.core.swap_BANG_.call(null, ten_seconds.levels.difficulty, function(a) {
    return 0.5 + a
  });
  return cljs.core.assoc.call(null, a, "\ufdd0:state", "memorize", "\ufdd0:object-list", c, "\ufdd0:original", c, "\ufdd0:changed", b, "\ufdd0:time", (new Date).getTime())
});
cljs.core._add_method.call(null, ten_seconds.levels.on_animate, "memorize", function(a) {
  var b = (new Date).getTime(), c = (new cljs.core.Keyword("\ufdd0:time")).call(null, a), b = 10 - ((b - c) / 1E3 | 0), c = (new cljs.core.Keyword("\ufdd0:object-list")).call(null, a), c = cljs.core.cons.call(null, cljs.core.assoc.call(null, cljs.core.first.call(null, c), "\ufdd0:msg", [cljs.core.str(b), cljs.core.str(" seconds.")].join("")), cljs.core.rest.call(null, c));
  return 0 >= b ? cljs.core.assoc.call(null, a, "\ufdd0:object-list", cljs.core.List.EMPTY, "\ufdd0:state", "black", "\ufdd0:time", (new Date).getTime()) : cljs.core.assoc.call(null, a, "\ufdd0:object-list", c)
});
cljs.core._add_method.call(null, ten_seconds.levels.on_animate, "black", function(a) {
  var b = (new Date).getTime(), c = (new cljs.core.Keyword("\ufdd0:time")).call(null, a), b = 2 - ((b - c) / 1E3 | 0);
  (new cljs.core.Keyword("\ufdd0:object-list")).call(null, a);
  return 0 >= b ? cljs.core.assoc.call(null, a, "\ufdd0:object-list", (new cljs.core.Keyword("\ufdd0:changed")).call(null, a), "\ufdd0:state", "solve", "\ufdd0:time", (new Date).getTime()) : cljs.core.assoc.call(null, a, "\ufdd0:done", !1)
});
cljs.core._add_method.call(null, ten_seconds.levels.on_animate, "solve", function(a) {
  var b = (new Date).getTime(), c = (new cljs.core.Keyword("\ufdd0:time")).call(null, a), d = 10 - ((b - c) / 1E3 | 0), c = (new cljs.core.Keyword("\ufdd0:object-list")).call(null, a), b = cljs.core.filter.call(null, function(a) {
    return cljs.core.contains_QMARK_.call(null, a, "\ufdd0:changed")
  }, c), c = cljs.core.cons.call(null, cljs.core.assoc.call(null, cljs.core.first.call(null, c), "\ufdd0:msg", [cljs.core.str(d), cljs.core.str(" seconds.")].join("")), cljs.core.rest.call(null, c));
  b = (d = 0 >= d) ? d : cljs.core._EQ_.call(null, 0, cljs.core.count.call(null, b));
  return b ? cljs.core.assoc.call(null, a, "\ufdd0:state", "check", "\ufdd0:object-list", c) : cljs.core.assoc.call(null, a, "\ufdd0:object-list", c)
});
cljs.core._add_method.call(null, ten_seconds.levels.on_animate, "show", function(a) {
  var b = (new Date).getTime(), c = (new cljs.core.Keyword("\ufdd0:time")).call(null, a), b = 2 - ((b - c) / 1E3 | 0), c = (new cljs.core.Keyword("\ufdd0:object-list")).call(null, a), c = cljs.core.cons.call(null, cljs.core.assoc.call(null, cljs.core.first.call(null, c), "\ufdd0:msg", "" + cljs.core.str("10 seconds. Game Over. You missed some changes. ")), cljs.core.rest.call(null, c));
  return 0 >= b ? (cljs.core.swap_BANG_.call(null, ten_seconds.levels.difficulty, function() {
    return 0 + ten_seconds.levels.initial_difficulty
  }), cljs.core.assoc.call(null, a, "\ufdd0:game-over", !0)) : cljs.core.assoc.call(null, a, "\ufdd0:object-list", c)
});
cljs.core._add_method.call(null, ten_seconds.levels.on_animate, "check", function(a) {
  var b = (new cljs.core.Keyword("\ufdd0:object-list")).call(null, a), c = cljs.core.filter.call(null, function(a) {
    return cljs.core.contains_QMARK_.call(null, a, "\ufdd0:changed")
  }, b);
  return cljs.core.not_EQ_.call(null, 0, cljs.core.count.call(null, c)) ? cljs.core.assoc.call(null, a, "\ufdd0:state", "show", "\ufdd0:object-list", cljs.core.map.call(null, function(a) {
    return cljs.core.assoc.call(null, a, "\ufdd0:outline", !0)
  }, b), "\ufdd0:time", (new Date).getTime()) : cljs.core.assoc.call(null, a, "\ufdd0:done", !0)
});
ten_seconds.levels.level1 = cljs.core.PersistentArrayMap.fromArray(["\ufdd0:next-level", "level1", "\ufdd0:done", !1, "\ufdd0:state", "first", "\ufdd0:on-animate", function(a) {
  return ten_seconds.levels.on_animate.call(null, a)
}, "\ufdd0:on-render", function() {
  return console.log("level1 render")
}, "\ufdd0:on-click", function(a, b) {
  console.log("level1 on-click");
  if(cljs.core._EQ_.call(null, (new cljs.core.Keyword("\ufdd0:state")).call(null, a), "solve")) {
    var c = (new cljs.core.Keyword("\ufdd0:object-list")).call(null, a), d = cljs.core.mapcat.call(null, function(a) {
      return function(b) {
        return ten_seconds.utils.hit_test.call(null, (new cljs.core.Keyword("\ufdd0:x")).call(null, b), (new cljs.core.Keyword("\ufdd0:y")).call(null, b), a)
      }
    }(c), b);
    cljs.core.filter.call(null, function(a) {
      return cljs.core.contains_QMARK_.call(null, a, "\ufdd0:changed")
    }, d);
    var e = cljs.core.filter.call(null, cljs.core.complement.call(null, function(a) {
      return cljs.core.contains_QMARK_.call(null, a, "\ufdd0:changed")
    }), d), c = ten_seconds.utils.difference.call(null, c, d), e = 0 < cljs.core.count.call(null, e) ? "check" : (new cljs.core.Keyword("\ufdd0:state")).call(null, a);
    return cljs.core.assoc.call(null, a, "\ufdd0:object-list", c, "\ufdd0:state", e)
  }
  return cljs.core.assoc.call(null, a, "\ufdd0:state", (new cljs.core.Keyword("\ufdd0:state")).call(null, a))
}, "\ufdd0:display-counter", cljs.core.PersistentArrayMap.fromArray(["\ufdd0:type", "text", "\ufdd0:msg", "10 seconds.", "\ufdd0:font", "20px Arial", "\ufdd0:x", 10, "\ufdd0:y", 20, "\ufdd0:color", cljs.core.PersistentVector.fromArray([210, 200, 210], !0), "\ufdd0:alpha", 1], !0)], !0);
ten_seconds.levels.intro = cljs.core.PersistentArrayMap.fromArray(["\ufdd0:next-level", "level1", "\ufdd0:done", !1, "\ufdd0:on-animate", function(a) {
  return cljs.core.assoc.call(null, a, "\ufdd0:done", !1, "\ufdd0:first", !1)
}, "\ufdd0:on-render", function() {
  return console.log("intro render")
}, "\ufdd0:on-click", function(a) {
  console.log("intro on-click");
  return cljs.core.assoc.call(null, a, "\ufdd0:done", !0)
...
"\ufdd0:font", "20px Arial", "\ufdd0:x", 210, "\ufdd0:y", 210, "\ufdd0:color", cljs.core.vec([210, 200, 210]), "\ufdd0:alpha", 1), cljs.core.hash_map("\ufdd0:type", "text", "\ufdd0:msg", "Click to start.", "\ufdd0:font", "20px Arial", "\ufdd0:x", 310, "\ufdd0:y", 310, "\ufdd0:color", cljs.core.vec([210, 200, 210]), "\ufdd0:alpha", 1)), cljs.core.hash_map("\ufdd0:line", 293, "\ufdd0:column", 16))], !0);
ten_seconds.levels.game_over = cljs.core.PersistentArrayMap.fromArray(["\ufdd0:next-level", "intro", "\ufdd0:done", !1, "\ufdd0:on-animate", function(a) {
  return cljs.core.assoc.call(null, a, "\ufdd0:done", !1, "\ufdd0:first", !1)
}, "\ufdd0:on-render", function() {
...
"\ufdd0:msg", "Next time, try harder!", "\ufdd0:font", "20px Arial", "\ufdd0:x", 110, "\ufdd0:y", 110, "\ufdd0:color", cljs.core.vec([210, 200, 210]), "\ufdd0:alpha", 1), cljs.core.hash_map("\ufdd0:type", "text", "\ufdd0:msg", "Click to restart.", "\ufdd0:font", "20px Arial", "\ufdd0:x", 310, "\ufdd0:y", 310, "\ufdd0:color", cljs.core.vec([210, 200, 210]), "\ufdd0:alpha", 1)), cljs.core.hash_map("\ufdd0:line", 317, "\ufdd0:column", 16))], !0);
ten_seconds.audio = {};
...
ten_seconds.audio.play_sound = function(a, b) {
  var c = ten_seconds.audio.audio_context.createBufferSource();
  c.connect(ten_seconds.audio.audio_context.destination);
  c.buffer = a;
  c.loop = b;
  return c.noteOn(0)
};
ten_seconds.audio.play_by_name = function() {
  console.log("play-by-name");
  for(var a = cljs.core.seq.call(null, cljs.core.deref.call(null, ten_seconds.audio.loaded_audio)), b = null, c = 0, d = 0;;) {
    if(d < c) {
      var e = cljs.core._nth.call(null, b, d);
      console.log((new cljs.core.Keyword("\ufdd0:name")).call(null, e));
      ten_seconds.audio.play_sound.call(null, (new cljs.core.Keyword("\ufdd0:buffer")).call(null, e), !0);
      d += 1
    }else {
      if(a = cljs.core.seq.call(null, a)) {
        b = a, cljs.core.chunked_seq_QMARK_.call(null, b) ? (a = cljs.core.chunk_first.call(null, b), c = cljs.core.chunk_rest.call(null, b), b = a, e = cljs.core.count.call(null, a), a = c, c = e) : (e = cljs.core.first.call(null, b), console.log((new cljs.core.Keyword("\ufdd0:name")).call(null, e)), ten_seconds.audio.play_sound.call(null, (new cljs.core.Keyword("\ufdd0:buffer")).call(null, e), !0), a = cljs.core.next.call(null, b), b = null, c = 0), d = 0
      }else {
        return null
      }
    }
...
ten_seconds.audio.load_audio = function(a, b) {
  var c = ten_seconds.audio.audio_context, d = new XMLHttpRequest, e = cljs.core.async.chan.call(null), f = cljs.core.async.chan.call(null);
  d.open("GET", a, !0);
  d.responseType = "arraybuffer";
  d.onload = function() {
    console.log("Loaded cb");
    return cljs.core.async.put_BANG_.call(null, e, d.response)
  };
  d.send();
  console.log("Start");
  ...
  cljs.core.async.impl.dispatch.run.call(null, function() {
    var a = function(a) {
      var b = a[1];
      if(2 === b) {
        var d = a[2], b = console.log("Loaded chan"), d = c.decodeAudioData(d, function(a) {
          console.log("Decoded");
          return cljs.core.async.put_BANG_.call(null, f, a)
        }, function() {
      ...
      return 1 === b ? cljs.core.async.impl.ioc_helpers.take_BANG_.call(null, a, 2, e) : null
    }, b = null, d = function() {
      var a = Array(6);
      a[0] = b;
      a[1] = 1;
  ...
  cljs.core.async.impl.dispatch.run.call(null, function() {
    var a = function(a) {
      var c = a[1];
      if(2 === c) {
        var d = a[2], c = console.log("Decoded chan"), e = cljs.core.swap_BANG_.call(null, ten_seconds.audio.loaded_audio, function(a) {
          return cljs.core.cons.call(null, cljs.core.PersistentArrayMap.fromArray(["\ufdd0:buffer", d, "\ufdd0:name", b], !0), a)
        }), g = ten_seconds.audio.play_by_name.call(null, b);
        a[5] = c;
        a[6] = e;
        return cljs.core.async.impl.ioc_helpers.return_chan.call(null, a, g)
      }
      return 1 === c ? cljs.core.async.impl.ioc_helpers.take_BANG_.call(null, a, 2, f) : null
    }, c = null, d = function() {
      var a = Array(7);
      a[0] = c;
      a[1] = 1;
    ...
    var g = c.call(null);
    g[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = h;
...
ten_seconds.canvas = {};
ten_seconds.canvas.render_text = function(a, b) {
  a.fillStyle = [cljs.core.str("rgba("), cljs.core.str(clojure.string.join.call(null, ",", (new cljs.core.Keyword("\ufdd0:color")).call(null, b))), cljs.core.str(","), cljs.core.str((new cljs.core.Keyword("\ufdd0:alpha")).call(null, b)), cljs.core.str(")")].join("");
  a.font = (new cljs.core.Keyword("\ufdd0:font")).call(null, b);
  return a.fillText((new cljs.core.Keyword("\ufdd0:msg")).call(null, b), (new cljs.core.Keyword("\ufdd0:x")).call(null, b), (new cljs.core.Keyword("\ufdd0:y")).call(null, b))
};
ten_seconds.canvas.render_circle = function(a, b) {
  a.fillStyle = [cljs.core.str("rgba("), cljs.core.str(clojure.string.join.call(null, ",", (new cljs.core.Keyword("\ufdd0:color")).call(null, b))), cljs.core.str(","), cljs.core.str((new cljs.core.Keyword("\ufdd0:alpha")).call(null, b)), cljs.core.str(")")].join("");
  a.beginPath();
  a.arc((new cljs.core.Keyword("\ufdd0:x")).call(null, b), (new cljs.core.Keyword("\ufdd0:y")).call(null, b), (new cljs.core.Keyword("\ufdd0:radius")).call(null, b), 0, 2 * Math.PI, !0);
  a.fill();
  var c;
  c = (c = cljs.core.contains_QMARK_.call(null, b, "\ufdd0:changed")) ? cljs.core.contains_QMARK_.call(null, b, "\ufdd0:outline") : c;
  return c ? (a.lineWidth = 5, a.strokeStyle = "#ffffff", a.stroke()) : null
};
ten_seconds.canvas.render_rect = function(a, b) {
  a.fillStyle = [cljs.core.str("rgba("), cljs.core.str(clojure.string.join.call(null, ",", (new cljs.core.Keyword("\ufdd0:color")).call(null, b))), cljs.core.str(","), cljs.core.str((new cljs.core.Keyword("\ufdd0:alpha")).call(null, b)), cljs.core.str(")")].join("");
  a.beginPath();
  a.rect((new cljs.core.Keyword("\ufdd0:left")).call(null, b), (new cljs.core.Keyword("\ufdd0:top")).call(null, b), (new cljs.core.Keyword("\ufdd0:width")).call(null, b), (new cljs.core.Keyword("\ufdd0:height")).call(null, b));
  a.fill();
  var c;
  c = (c = cljs.core.contains_QMARK_.call(null, b, "\ufdd0:changed")) ? cljs.core.contains_QMARK_.call(null, b, "\ufdd0:outline") : c;
  return c ? (a.lineWidth = 5, a.strokeStyle = "#ffffff", a.stroke()) : null
...
ten_seconds.game.initial_state = function() {
  return cljs.core.PersistentArrayMap.fromArray(["\ufdd0:level", ten_seconds.levels.intro], !0)
};
ten_seconds.game.render_level = function(a, b) {
  for(var c = (new cljs.core.Keyword("\ufdd0:object-list")).call(null, b), c = cljs.core.seq.call(null, cljs.core.reverse.call(null, c)), d = null, e = 0, f = 0;;) {
    if(f < e) {
      var g = cljs.core._nth.call(null, d, f);
      cljs.core._EQ_.call(null, "circle", (new cljs.core.Keyword("\ufdd0:type")).call(null, g)) ? ten_seconds.canvas.render_circle.call(null, a, g) : cljs.core._EQ_.call(null, "rect", (new cljs.core.Keyword("\ufdd0:type")).call(null, g)) ? ten_seconds.canvas.render_rect.call(null, a, g) : cljs.core._EQ_.call(null, "text", (new cljs.core.Keyword("\ufdd0:type")).call(null, g)) && ten_seconds.canvas.render_text.call(null, a, g);
      f += 1
    }else {
      if(c = cljs.core.seq.call(null, c)) {
        d = c, cljs.core.chunked_seq_QMARK_.call(null, d) ? (c = cljs.core.chunk_first.call(null, d), e = cljs.core.chunk_rest.call(null, d), d = c, g = cljs.core.count.call(null, c), c = e, e = g) : (g = cljs.core.first.call(null, d), cljs.core._EQ_.call(null, "circle", (new cljs.core.Keyword("\ufdd0:type")).call(null, g)) ? ten_seconds.canvas.render_circle.call(null, a, g) : cljs.core._EQ_.call(null, "rect", (new cljs.core.Keyword("\ufdd0:type")).call(null, g)) ? ten_seconds.canvas.render_rect.call(null, 
        a, g) : cljs.core._EQ_.call(null, "text", (new cljs.core.Keyword("\ufdd0:type")).call(null, g)) && ten_seconds.canvas.render_text.call(null, a, g), c = cljs.core.next.call(null, d), d = null, e = 0), f = 0
      }else {
        return null
      }
    }
...
ten_seconds.game.convert_level = function(a) {
  return cljs.core._EQ_.call(null, a, "intro") ? ten_seconds.levels.intro : cljs.core._EQ_.call(null, a, "level1") ? ten_seconds.levels.level1 : ten_seconds.levels.game_over
};
ten_seconds.game.next_state = function(a) {
  var b = (new cljs.core.Keyword("\ufdd0:level")).call(null, a), c = (new cljs.core.Keyword("\ufdd0:on-animate")).call(null, b), d = (new cljs.core.Keyword("\ufdd0:done")).call(null, b), e;
  e = (e = cljs.core.contains_QMARK_.call(null, b, "\ufdd0:game-over")) ? (new cljs.core.Keyword("\ufdd0:game-over")).call(null, b) : e;
  return cljs.core._EQ_.call(null, !0, d) ? cljs.core.assoc.call(null, a, "\ufdd0:level", ten_seconds.game.convert_level.call(null, (new cljs.core.Keyword("\ufdd0:next-level")).call(null, b))) : cljs.core._EQ_.call(null, !0, e) ? cljs.core.assoc.call(null, a, "\ufdd0:level", ten_seconds.game.convert_level.call(null, "game-over")) : cljs.core.assoc.call(null, a, "\ufdd0:level", c.call(null, b))
};
ten_seconds.game.render = function(a) {
  var b = document.getElementById("surface").getContext("2d");
  b.fillStyle = [cljs.core.str("rgba("), cljs.core.str(0), cljs.core.str(","), cljs.core.str(0), cljs.core.str(","), cljs.core.str(0), cljs.core.str(","), cljs.core.str(1), cljs.core.str(")")].join("");
  b.fillRect(0, 0, ten_seconds.game.canvas_width, ten_seconds.game.canvas_height);
  return ten_seconds.game.render_level.call(null, b, (new cljs.core.Keyword("\ufdd0:level")).call(null, a))
};
ten_seconds.game.request_animation_frame = function() {
  ...
  return cljs.core.truth_(a) ? a : function(a) {
    return timeout(10, a.call(null))
  }
}();
ten_seconds.game.process_clicks = function(a, b) {
  if(cljs.core.seq.call(null, b)) {
    var c = (new cljs.core.Keyword("\ufdd0:level")).call(null, a), c = (new cljs.core.Keyword("\ufdd0:on-click")).call(null, c).call(null, c, b);
    return cljs.core.assoc.call(null, a, "\ufdd0:level", c)
  }
  return a
};
ten_seconds.game.clear_clicks = function() {
  return cljs.core.PersistentVector.EMPTY
};
ten_seconds.game.animate = function animate(b) {
  var c = ten_seconds.game.process_clicks.call(null, b, cljs.core.deref.call(null, ten_seconds.game.clicks));
  cljs.core.swap_BANG_.call(null, ten_seconds.game.clicks, ten_seconds.game.clear_clicks);
  ten_seconds.game.render.call(null, c);
  return ten_seconds.game.request_animation_frame.call(null, function() {
    return animate.call(null, ten_seconds.game.next_state.call(null, c))
  })
};
...
ten_seconds.game.init = function() {
  ...
  a.height = ten_seconds.game.canvas_height;
  a.addEventListener("click", function(a) {
    return ten_seconds.game.click.call(null, a)
  }, !1);
  try {
    var b = new Audio, c = b.canPlayType("audio/ogg; codecs='vorbis'"), d = b.canPlayType("audio/mpeg;"), e = b.canPlayType("audio/wav; codecs='1'");
    console.log("ogg", c, "mp3", d, "wav", e);
    var f;
    var g = cljs.core._EQ_.call(null, c, "maybe");
    f = g ? g : cljs.core._EQ_.call(null, c, "probably");
    if(f) {
      ten_seconds.audio.load_audio.call(null, "audio/ludumdare10seconds.ogg", "music")
    }else {
      var h;
      var i = cljs.core._EQ_.call(null, d, "maybe");
      h = i ? i : cljs.core._EQ_.call(null, d, "probably");
      if(h) {
        ten_seconds.audio.load_audio.call(null, "audio/ludumdare10seconds.mp3", "music")
      }else {
        var j;
        var k = cljs.core._EQ_.call(null, e, "maybe");
        j = k ? k : cljs.core._EQ_.call(null, e, "probably");
        j && ten_seconds.audio.load_audio.call(null, "audio/ludumdare10seconds.wav", "music")
      }
    }
  }catch(m) {
